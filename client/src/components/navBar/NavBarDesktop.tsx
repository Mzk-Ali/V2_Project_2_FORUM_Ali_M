...
export default function NavBarDesktop() {
    ...
    return(
        <nav className="hidden sm:flex justify-between items-center px-4 h-full">
            ...
            <div className="flex gap-1 md:gap-5 font-semibold">
            ...
            <div className="text-xl flex space-x-3">
                <ButtonDarkMode />
                <div onClick={handleOpenProfile} className="rounded-full cursor-pointer bg-white size-10 flex justify-center items-center dark:bg-blue-950">
                    {isAuthenticated ?
