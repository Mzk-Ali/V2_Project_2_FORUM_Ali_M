export default function PopularFilter() {
    return(
        <div className="flex items-center w-full flex-nowrap overflow-x-auto gap-3">
            <div className="inline px-4 py-2 rounded-md bg-slate-300 hover:bg-slate-400 cursor-pointer font-semibold dark:bg-slate-900 dark:hover:bg-slate-950">Plus Récent</div>
