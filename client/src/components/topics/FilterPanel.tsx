    ...
    return(
        <div className="flex justify-between items-center w-full">
            ...
            <div className="flex items-center gap-4">
                ...
                <button onClick={handleOpenFilter} className="relative flex justify-center items-center gap-2 font-semibold rounded-md px-2 py-1 shadow-md lg:bg-slate-200 lg:hover:bg-slate-300 lg:dark:bg-slate-900 lg:dark:hover:bg-slate-950">
                    <span className="hidden lg:block p-1">Filtrer</span>
                    <FontAwesomeIcon icon={faFilter} className="size-5 p-1" />
                    {isOpenFilter && (
                        <div className="absolute top-full my-2 right-0 bg-white border border-slate-300 rounded-md p-2">
                            filtre
                        </div>
                    )}
                </button>
